...
;(function($) {
    ...
    $.extend(L, {
        ...
        setAjax: function(l) {
            if (l.onAjax) {
                var self = this, A = l.ajax = {
                    start: function() { l.on.call(self, l); },
                    stop: function() { l.off.call(self, l, l); }
                };
        ...
        initImg: function(l) {
            var self = this;
            l.img = $('<img src="'+l.img+'"/>').bind('load', function() {
                l.init.call(self, l);
            });
        ...
        create: function(l) {
            ...
            if (l.text && !l.img && !l.element) el.text(l.text);
