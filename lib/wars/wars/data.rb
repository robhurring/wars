module Wars
  module Data
    ...
    Products = [
      ...
      Product.new(:id => 3, :name => 'Dell Desktop', :price_range => (900..1500), :min_message => 'The new Windows OS is riddled with bugs! People are dumping their PCs into the dumpster!', :max_message => 'Microsoft is releasing a new OS! Computer prices have jumped!'),
